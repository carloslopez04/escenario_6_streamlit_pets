...
st.image("C:\Users\c.lopez.munoz\Documents\prueba_docker\escenario_6_streamlit_pets\img\foto-de-dibujo-colorido-gato-marrón.webp")
...
if st.button("Predecir"):
    ...
    st.success(f'La mascota es un {prediction_map} ', icon="✅")
    st.balloons()
